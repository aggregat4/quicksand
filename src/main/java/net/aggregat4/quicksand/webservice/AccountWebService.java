        ...
        if (returnSearchResults) {
            ...
            return List.of(
                    EmailGroup.createNoGroupEmailgroup(List.of(
                            new EmailHeader(1, 1, List.of(MockEmailData.EMAIL1_SENDER, MockEmailData.EMAIL1_RECIPIENT), MockEmailData.EMAIL1_SUBJECT, MockEmailData.EMAIL1_RECEIVEDDATE, MockEmailData.EMAIL1_SENTDATE, "Hey you, this is me <mark>John</mark> sending you this somewhere what is this and this snippet just goes on", false, true, false),
                            ...
                            new EmailHeader(5, 5, List.of(new Actor(ActorType.SENDER, "<mark>john</mark>@waterman.org", Optional.of("<mark>John</mark> Doe")), MockEmailData.EMAIL1_RECIPIENT), "Hi", ZonedDateTime.now().minus(3, ChronoUnit.DAYS), ZonedDateTime.now().minus(3, ChronoUnit.DAYS), "JKHGajkls glasjkdfgh djshfsdklj fhskdjlfh asdkljfh asdkljf qweuihawioeusdv bj", true, false, true)
                    ))
            );
        } else {
            return List.of(
                    new EmailGroup.TodayEmailGroup(List.of(
                            new EmailHeader(1, 1, List.of(MockEmailData.EMAIL1_SENDER, MockEmailData.EMAIL1_RECIPIENT), MockEmailData.EMAIL1_SUBJECT, MockEmailData.EMAIL1_RECEIVEDDATE, MockEmailData.EMAIL1_SENTDATE, "Hey you, this is me sending you this somewhere what is this and this snippet just goes on", false, true, false),
                            new EmailHeader(2, 2, List.of(MockEmailData.EMAIL2_SENDER, MockEmailData.EMAIL2_RECIPIENT), MockEmailData.EMAIL2_SUBJECT, MockEmailData.EMAIL2_RECEIVEDDATE, MockEmailData.EMAIL2_SENTDATE, "Asd askl; sdkljhs ldkjfhaslkdjfhalksdjfh aslkd  falskjd alskdfhqw qwe ", false, false, false))),
