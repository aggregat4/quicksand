...
public class ResponseUtils {
   ...
   *
   * <p><a
   * href="https://github.com/spring-projects/spring-framework/blob/main/spring-web/src/main/java/org/springframework/http/ContentDisposition.java">ContentDisposition
   * in Spring</a>
   */
  ...
  static Consumer<Throwable> asyncExceptionConsumer(ServerResponse response) {
    return throwable -> {
      if (throwable instanceof CompletionException completionException
          && completionException.getCause() instanceof HttpException httpException) {
